      ...
      return (
        <div>
          {data.help.map((item, index) => (
            <div key={index}>
              <span className="text-green-500 ml-3">{item.label}</span> -{" "}
              {item.content} <br />
            </div>
          ))}
        </div>
    ...
    case "about":
      return (
        <div>
          ...
          <br></br>
          <div>
            <span className="text-green-500 font-bold"> I'm Umer</span>, a 3rd
            ...
            pursuing{" "}
            <span className="text-green-500">Bachelor of Computer Science</span>
            .<br></br>
          </div>
        </div>
      );
